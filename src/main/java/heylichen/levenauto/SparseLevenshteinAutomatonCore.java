...
/**
 * basically the same as SparseLevenshteinDistanceMatcher,
 * except state are passed as parameter instead of instance variable.
 */
public class SparseLevenshteinAutomatonCore {
  private final String string;
  private final int maxEdits;

  public SparseLevenshteinAutomatonCore(String string, int maxEdits) {
    this.string = string;
    this.maxEdits = maxEdits;
  }

  public List<IndexValue> start() {
