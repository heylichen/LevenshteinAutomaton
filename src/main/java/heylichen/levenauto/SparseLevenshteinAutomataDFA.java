...
public class SparseLevenshteinAutomataDFA {
  private int idCounter = 0;
  private Map<String, Integer> stateMap;
  private List<Transition> transitions;
  private Set<Integer> matchedStateIds;
  private final SparseLevenshteinAutomata automatonCore;
  ...
  public SparseLevenshteinAutomataDFA(SparseLevenshteinAutomata lm) {
  ...
  private void init() {
    ...
    explore(automatonCore.getStartState());
    ...
    this.matchEmptyInput = automatonCore.isMatch(automatonCore.getStartState());
  }
